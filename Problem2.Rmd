...
Visualizing weather patterns from the **NY NOAA dataset** 
...
Including four interactive Plotly charts demonstrating different plot types: box plots, scatter plots, line plots, and bar plots.

Visualizations {data-width=500}
-----------------------------------------------------------------------

### Box Plot: Temperature Range by Month
...
### Scatter Plot: Precipitation vs Snowfall
...
### Line Plot: Average Temperature Trend by Year
...
### Bar Plot: Snowfall Distribution by Season 
